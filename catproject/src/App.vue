<template>
  <!-- <div style="text-align: left">
    ...
    <img alt="Vue logo" src="./assets/kantoku-seraph.jpg">
  </div> -->
  <!-- <router-view/>タグを追加する事でVue Routerが機能するようになる -->
  <router-view/>
</template>
...
.login-google {
  ...
  .login-google button {
    background-color: #19496f; /* ボタンの背景色 */
    color: #ffffff; /* テキストの色 */
  ...
  text-align: center; /* プレースホルダーテキストを中央揃えにする */
  }
  .create-account {
    width: 300px;
    margin: 0 auto;
